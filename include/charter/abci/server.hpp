...
struct reactor final : public grpc::ServerUnaryReactor {
  ...
  std::variant<std::monostate, tendermint::abci::RequestEcho,
               tendermint::abci::RequestFlush, tendermint::abci::RequestInfo,
               tendermint::abci::RequestCheckTx, tendermint::abci::RequestQuery,
      ...
      request;
  std::variant<
      std::monostate, tendermint::abci::ResponseEcho *,
      tendermint::abci::ResponseFlush *, tendermint::abci::ResponseInfo *,
      tendermint::abci::ResponseCheckTx *, tendermint::abci::ResponseQuery *,
      tendermint::abci::ResponseCommit *, tendermint::abci::ResponseInitChain *,
...
struct listener final : public tendermint::abci::ABCI::CallbackService {
  ...
  Echo(grpc::CallbackServerContext * /*context*/,
