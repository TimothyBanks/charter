...
void encode(propose_destination_update<1>&& o, ::scale::Encoder& encoder) {
  ...
  encode(o.delay_ms, encoder);
}

void decode(propose_destination_update<1>&& o, ::scale::Decoder& decoder) {
